...
// DepositResourceAdministrative Administrative metadata for the resource within TAQUITO.
...
type DepositResourceAdministrative struct {
	...
	// Pointer to the XML file that is a traditional representation of the metadata.
	...
	// remediated by
	RemediatedBy DepositResourceAdministrativeRemediatedBy `json:"remediatedBy"`
