...
//go:generate swagger generate server --target ../generated --name  --spec ../swagger.json --principal models.Agent --exclude-main

func configureFlags(api *operations.TaquitoAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.TaquitoAPI) http.Handler {
	...
	api.RemoteUserAuth = func(token string) (*models.Agent, error) {
	...
	api.DepositResourceHandler = operations.DepositResourceHandlerFunc(func(params operations.DepositResourceParams, principal *models.Agent) middleware.Responder {
	...
	api.RetrieveResourceHandler = operations.RetrieveResourceHandlerFunc(func(params operations.RetrieveResourceParams, principal *models.Agent) middleware.Responder {
