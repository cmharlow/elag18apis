...
func NewTaquitoAPI(spec *loads.Document) *TaquitoAPI {
	return &TaquitoAPI{
		...
		DepositResourceHandler: DepositResourceHandlerFunc(func(params DepositResourceParams, principal *models.Agent) middleware.Responder {
		...
		RetrieveResourceHandler: RetrieveResourceHandlerFunc(func(params RetrieveResourceParams, principal *models.Agent) middleware.Responder {
		...
		RemoteUserAuth: func(token string) (*models.Agent, error) {
...
/*TaquitoAPI TAQUITO, a Simple Digital Repository Management Layer API */
type TaquitoAPI struct {
	spec            *loads.Document
	...
	RemoteUserAuth func(string) (*models.Agent, error)
...
func (o *TaquitoAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *TaquitoAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *TaquitoAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *TaquitoAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *TaquitoAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *TaquitoAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *TaquitoAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the TaquitoAPI
func (o *TaquitoAPI) Validate() error {
...
func (o *TaquitoAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *TaquitoAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *TaquitoAPI) Authorizer() runtime.Authorizer {
...
func (o *TaquitoAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *TaquitoAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *TaquitoAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the taquito API
func (o *TaquitoAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *TaquitoAPI) initHandlerCache() {
...
func (o *TaquitoAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
