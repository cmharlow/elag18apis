...
Update TAQUITO Resource.

Updates the metadata for an existing TAQUITO resource. Only include required fields and fields you wish to change. Will return the TAQUITO resource identifier.
